        ...
        <StyleRightCont>
            ...
            <div className="travel-limited">
                ...
                <div className="upper-box">
                    <h2>Ideal Travels l Private Limited</h2>
                    <spam>NON A/C Sleeper (2+1)</spam>
                </div>


                <div className="seat-selected">
                    Seats Selected  <spam className="dot">.</spam><spam> L13 L14</spam>
                </div>
            ...
            <div className="point-details-card">
                ...
                <div className="boarding-point Point-detail-content">
                    ...
                    <div>11:55 PM, 26th Jul 2021</div>

                    <h2>Kottara</h2>

                    <p>Ideal Travels ,43'Rahul Complex,Block 1, Near S.T. Bus Stand ,Nagpur</p>
                ...
                <div className="dropping-point Point-detail-content">
                    ...
                    <div>08:55 PM, 27th Jul 2021</div>
