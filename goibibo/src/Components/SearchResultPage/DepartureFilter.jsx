...
import styles from "./DepartureFilter.module.css"
...
function FilterDeparture() {
    ...
    return (
        <div className={styles.departure_main}>
            <div className={styles.heading_wrapper}>
                <div className={styles.heading}>Departure Time</div>
                {departureFilter === null ? <div className={styles.reset_desable} >Reset</div> : <div className={styles.reset}>Reset</div> }
            </div>
